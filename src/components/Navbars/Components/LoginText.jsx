...
const LoginText = () => {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="relative flex items-center px-4 py-2 space-x-2 overflow-hidden text-xs text-sm italic tracking-wide text-black transition-all duration-100 border rounded-full cursor-pointer md:px-4 md:py-2 md:text-sm border-invaPurple font-poppins group "
    >
      {/* Ripple Fill Effect */}
